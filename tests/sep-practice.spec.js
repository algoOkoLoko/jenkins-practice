...
test("SEP Practice @sep", async ({ page }) => {
  ...
  let expiryDateInputBox = paymentFrame.locator(
    "//input[@id='payment-expiryInput']",
  );
  await expiryDateInputBox.fill("12/34");

  let cvcInputBox = paymentFrame.locator("//input[@id='payment-cvcInput']");
